...
const SUCESS_DELETED_ITEM = {status: true, status_code: 200, message: "Item excluida com sucesso!!!"}
const SUCESS_UPDATED_ITEM = {status: true, status_code: 200, message: "Item atualizada com sucesso!!!"}
